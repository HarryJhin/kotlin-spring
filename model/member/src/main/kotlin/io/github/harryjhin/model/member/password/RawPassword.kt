...
value class RawPassword(val value: String) {
    ...
    fun encode(): EncodedPassword {
        return EncodedPassword(PASSWORD_ENCODER.encode(value))
    }

    fun matches(encodedPassword: EncodedPassword): Boolean {
        return PASSWORD_ENCODER.matches(value, encodedPassword.value)
    }
